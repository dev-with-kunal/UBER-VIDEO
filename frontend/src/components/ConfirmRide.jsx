...
const ConfirmRide = (props) => {
    return (
        <div>
            <h5 className='text-center w-[93%] absolute top-0' onClick={() => { props.setVehiclePannelOpen(false); }}>
            ...
            <div className='mt-5 w-full'>
                ...
                <button className=' mt-5 w-full bg-green-600 text-white p-2 rounded-lg font-semibold border-2 border-solid' onClick={() => {
